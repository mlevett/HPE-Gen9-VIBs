...
call :logFile ... obESXiVer6x      = "%obESXiVer6x%"
call :logFile ... obESXiVer60      = "%obESXiVer60%"
call :logFile ... obESXiVer65      = "%obESXiVer65%"
call :logFile ... obESXiVer67      = "%obESXiVer67%"
...
if "%obESXiVer6x%"=="1" (
   call :addMetadataRecord 6.* >>"%BDLDIR%\vendor-index.xml"
) else (
   if "%obESXiVer60%"=="1" call :addMetadataRecord 9.0.0 >>"%BDLDIR%\vendor-index.xml"
   if "%obESXiVer65%"=="1" call :addMetadataRecord 9.5.0 >>"%BDLDIR%\vendor-index.xml"
   if "%obESXiVer67%"=="1" call :addMetadataRecord 9.7.0 >>"%BDLDIR%\vendor-index.xml"
)
"%BUSYBOX%" echo "</metaList>">>"%BDLDIR%\vendor-index.xml"
...
if "%obESXiVer6x%"=="1" (
   "%BUSYBOX%" echo "      <softwarePlatform locale=\"\" version=\"6.*\" productLineID=\"embeddedEsx\"/>">>"%METADIR%\vmware.xml"
) else (
   if "%obESXiVer60%"=="1" "%BUSYBOX%" echo "      <softwarePlatform locale=\"\" version=\"9.0.0\" productLineID=\"embeddedEsx\"/>">>"%METADIR%\vmware.xml"
   if "%obESXiVer65%"=="1" "%BUSYBOX%" echo "      <softwarePlatform locale=\"\" version=\"9.5.0\" productLineID=\"embeddedEsx\"/>">>"%METADIR%\vmware.xml"
   if "%obESXiVer67%"=="1" "%BUSYBOX%" echo "      <softwarePlatform locale=\"\" version=\"9.7.0\" productLineID=\"embeddedEsx\"/>">>"%METADIR%\vmware.xml"
)
...
if "%obESXiVer6x%"=="1" (
   "%BUSYBOX%" echo -n "<softwarePlatform locale=\"\" version=\"6.*\" productLineID=\"embeddedEsx\"/>">>"%METADIR%\bulletins\%obName%-%obVersion%.xml"
) else (
   if "%obESXiVer60%"=="1" "%BUSYBOX%" echo -n "<softwarePlatform locale=\"\" version=\"9.0.0\" productLineID=\"embeddedEsx\"/>">>"%METADIR%\bulletins\%obName%-%obVersion%.xml"
   if "%obESXiVer65%"=="1" "%BUSYBOX%" echo -n "<softwarePlatform locale=\"\" version=\"9.5.0\" productLineID=\"embeddedEsx\"/>">>"%METADIR%\bulletins\%obName%-%obVersion%.xml"
   if "%obESXiVer67%"=="1" "%BUSYBOX%" echo -n "<softwarePlatform locale=\"\" version=\"9.7.0\" productLineID=\"embeddedEsx\"/>">>"%METADIR%\bulletins\%obName%-%obVersion%.xml"
)
...
:init_constants
   ...
   set SCRIPTURL=https://ESXi-CPT.v-front.de
...
:ParseVibXML
   ...
   echo.>>%3
   findstr /I /L "<maintenance-mode>" %1 | "%SED%" -e "s#.*<maintenance-mode>#set %2MaintMode=#I;s#</maintenance-mode>.*##I" >>%3
   echo.>>%3
   type %3 >>"%LOGFILE%" 2>&1
   call %3
goto :eof
...
:add2zip
   ...
   ( "%BUSYBOX%" echo "      <vib>"
	 ...
	 if not "!vibMaintMode!"=="" (
		"%BUSYBOX%" echo "          <maintenanceMode>!vibMaintMode!</maintenanceMode>"
	 )
   ) >>"%METADIR%\vmware.xml"
   if "%obESXiVer5x%"=="1" (
   ...
   if "%obESXiVer6x%"=="1" (
      "%BUSYBOX%" echo "          <swPlatform locale=\"\" version=\"6.*\" productLineID=\"embeddedEsx\"/>">>"%METADIR%\vmware.xml"
   ) else (
      if "%obESXiVer60%"=="1" "%BUSYBOX%" echo "          <swPlatform locale=\"\" version=\"9.0.0\" productLineID=\"embeddedEsx\"/>">>"%METADIR%\vmware.xml"
      if "%obESXiVer65%"=="1" "%BUSYBOX%" echo "          <swPlatform locale=\"\" version=\"9.5.0\" productLineID=\"embeddedEsx\"/>">>"%METADIR%\vmware.xml"
      if "%obESXiVer67%"=="1" "%BUSYBOX%" echo "          <swPlatform locale=\"\" version=\"9.7.0\" productLineID=\"embeddedEsx\"/>">>"%METADIR%\vmware.xml"
   )
   ( "%BUSYBOX%" echo "        </systemReqs>"
