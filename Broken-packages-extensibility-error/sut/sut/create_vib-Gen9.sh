...
<vib version="5.0">
  ...
  <software-tags>
    <tag>daemon</tag>
    <tag>ConfigSchema:sut-701.2.9.1.16-1OEM.701.0.0.16850804:sut:usr/lib/vmware/configmanager/schemas/sut-701.2.9.1.16-1OEM.701.0.0.16850804-schema.json:sha-256:56b7aad2372263d7aae5fe7206c4d7d2945dc031739e8de09eac5da6353ef285</tag>
  </software-tags>
  <system-requires>
